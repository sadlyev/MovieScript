            ...
            return (
                ...
                <header className="header">
                    ...
                    {data && (<Link to="/profile" className={`header_link ${pathname == "/profile" ? "header_link--active" : ""}`}>{data.name}</Link> )}
                     {data && (<Link  className={`header_link header_link--icon ${pathname == "/profile" ? "header_link--active" : ""}`} to="/profile"><img className={`header_link header_link--icon ${pathname == "/profile" ? "header_link--active" : ""}`} src={UserIcon} width="24" height="24"></img></Link> )}
